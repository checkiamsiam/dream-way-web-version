                    ...
                    <div className="col-lg-12 mt85 row align-items-center">
                        <div className="mb10 col-sm-6">
                            <div className="breadcrumb_content style2 mb30-991">
                                ...
                                <p>
                                    See the status of your owned and requested
                                    properties.
                                </p>
                            </div>
                        </div>
...
export async function getServerSideProps(context) {
    ...
    try {
        const myRequests = await axiosApi.get('/api/clients/getMyRequests', {
            headers: {
    ...
    try {
        const getMyProperty = await axiosApi.get('/api/clients/getMyProperty', {
            headers: {
                Authorization: `Bearer ${token}`,
            },
        });

        MyProperty = getMyProperty?.data?.response;
    } catch (error) {}
