...
const HeaderMenuContent = ({ float = "" }) => {
  ...
  return (
    <ul id="respMenu" className="ace-responsive-menu text-end d-lg-block d-none" data-menu-style="horizontal">
      <li>
        <Link href="/" className={router.pathname === "/" ? "ui-active" : undefined}>
      ...
      <li className="dropitem">
        <a
          href="#"
          className={
            properties.some((page) => page.routerPath === router.pathname || page.routerPath + "/[id]" === router.pathname) ? "ui-active" : undefined
          }
        >
          ...
          {properties.map((item) => (
            <li key={item.id}>
              <Link
                ...
                className={router.pathname === item.routerPath || item.routerPath + "/[id]" === router.pathname ? "ui-active" : undefined}
              >
                {item.name}
              </Link>
            </li>
      ...
      <li>
        <Link href="/notice-board" className={router.pathname === "/notice-board" ? "ui-active" : undefined}>
          <span className="title">Notice Board</span>
        </Link>
      </li>

      <li>
        <Link href="/my-property" className={router.pathname === "/my-property" ? "ui-active" : undefined}>
